  ...
  return (
    <div dir="rtl">
      ...
      <div class="lg:w-10/12 mx-auto lg:-mt-20 z-20 relative">
        <FaCircle className="text-mygreen text-4xl absolute z-20" style={{top: '-1rem', left:'1rem'}} />
        ...
        <section className="bg-bgcolor rounded-xl p-4 lg:p-8 text-center mb-16 py-14 relative">
          <FaCircle className="text-myorange text-4xl absolute" style={{bottom: '-1rem', left:'2rem'}} />
