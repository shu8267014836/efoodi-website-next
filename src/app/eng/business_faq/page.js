          ...
          <div id="accordion-collapse" data-accordion="collapse">
            ...
            <div className="mb-4">
              ...
              >
                <div class="p-5 border border-gray-200 rounded-xl">
                  <p class="mb-2 text-gray-500">
                    eFOODI is the one huge food court for many restaurants, so
                    you don&apos;t need to go through the hassle of finding
                    restaurants&apos; numbers, waiting on hold, or getting a
                    busy signal while dialling a restaurant number, or getting
                    the wrong order due to miscommunication over the phone!
                    Besides, by using eFOODI, you can view menus with pictures
                    of all your favourite restaurants on our easy-to-use website
                    and app.
                  </p>
                </div>
              </div>
