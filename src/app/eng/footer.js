    ...
    <footer>
      <div className="grid grid-cols-1 lg:grid-cols-3 bg-cyan-50 rounded-2xl p-4 lg:px-20 items-end">
        <div className="p-6 lg:absolute lg:contents ">
          <img
            class="lg:-mt-20 lg:-mb-10 scale-x-reverse"
            alt="image"
            src="/location.webp"
          />
        </div>

        <div class="flex flex-col col-span-2 pb-12 lg:ml-24">
          <h2 class="text-2xl xl:text-5xl mb-4 font-bold [&&]:leading-tight">
            Download the <span className="text-mypurple">eFooDi app</span>
          </h2>
          <div class="mb-6 text-lg leading-relaxed text-gray-500 ">
          ...
          <div className="lg:flex">
            ...
            <div class="flex justify-center lg:mx-6 mx-0 my-4 lg:my-0">
              <button class="w-1/2 lg:w-auto text-white bg-gray-800 py-3 px-6 hover:bg-opacity-80 rounded-lg text-sm text-start flex flex-row items-center">
                <div class="text-3xl me-3">
                  <FaGooglePlay />
                </div>
      ...
      <div class="mx-6 lg:mx-0 max-w-screen-xl space-y-8 pt-16 lg:space-y-16 lg:px-12">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <h2 class="sm:text-xl md:text-2xl xl:text-3xl mb-4">
              support@efoodi.net
            </h2>
