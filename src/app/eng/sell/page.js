  ...
  return (
    <div>
      <div class="bg-[url('/hero-image.webp')] h-screen bg-cover relative z-0">
        <div style={{background : '#52057a', opacity: 0.8, height: '100%'}}></div>
        <div className="absolute z-1 h-full w-full top-0">
          <Nav />

          <section class="flex-center h-full px-3">
            <div className="md:w-2/3 text-white text-center -mt-72">
              ...
              <button className="bg-myorange text-sm rounded-full p-3 w-1/2 lg:w-1/3 mb-4" onClick={scrollDown}>Become Partner</button>
            </div>
          </section>
        </div>
      </div>

      <div class="lg:w-10/12 mx-auto lg:-mt-20 z-20 relative">
        <FaCircle className="text-mygreen text-4xl absolute z-20" style={{top: '-1rem', right:'1rem'}} />

        <section className="bg-gray-100 rounded-xl grid grid-cols-2 lg:grid-cols-5 p-8 text-center mb-16">
          <div className="flex-vr mb-10">
            <div className="flex-hz"><img src="/target-audience.webp" alt="image" className="w-1/3 mb-4" /></div>
            <div className="font-bold text-lg md:text-xl lg:text-lg ">Sell to millions of eFOODi customers</div>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid lg:grid-cols-2 lg:px-12 relative">
            ...
            <div className="bg-bggray rounded-xl p-6 relative">
        ...
        <section className="bg-bgcolor rounded-xl p-4 lg:p-8 text-center mb-16 py-14 relative">
          <FaCircle className="text-myorange text-4xl absolute" style={{bottom: '-1rem', right:'2rem'}} />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5">
            <div className="flex-vr px-1 lg:px-6 mb-8">
