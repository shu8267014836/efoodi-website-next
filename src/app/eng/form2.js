...
export default function Form2() {
  return (
        <form class="myform">
            ...
            <div class="mb-5">
                <input type="text" id="" class="myinput px-6 border border-gray-600 bg-transparent" placeholder="Enter Full Name*" required />
            </div>
            ...
            <div class="mb-5">
                <textarea type="text" id="" class="myinput px-6 border border-gray-600 bg-transparent" placeholder="Type Your Message*" rows={3} required />
            </div>
