...
export default function Home() {
  return (
    <div class="md:w-11/12">
      ...
      <section class="text-black body-font mb-16">
        <div class="container mx-auto flex px-10 pt-5 md:flex-row flex-col items-center">
          ...
          <div  id="pattern" class="w-32 sm:w-40 lg:max-w-xl lg:w-full md:w-32 xl:w-5/6 bg-contain bg-no-repeat md:ml-30 xl:mr-12">
            <div class="w-full flex gap-3 justify-center p-6">
              <img class="object-cover object-center rounded-xl " alt="hero" src="/hero.webp" />
            </div>
          </div>
        </div>
      ...
      <section class="bg-cyan-50 text-center rounded-2xl p-12 mb-16">
        ...
        <div class="flex-hz">
          <div class="">
            <div class="p-4"><img src="./become-partner.webp" alt="image" /></div>
