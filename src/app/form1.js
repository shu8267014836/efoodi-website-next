...
export default function Form1() {
  return (
        <form class="myform mx-8">
            <div class="mb-5">
                <input type="text" id="" class="myinput px-6 border border-gray-600 bg-transparent" placeholder="اسم المشروع*" required />
            </div>
            <div class="mb-5">
            ...
            <div class="mb-5">
                <input type="text" id="" class="myinput px-6 border border-gray-600 bg-transparent" placeholder="اسم الشخص للتواصل*" required />
            </div>
            ...
            <div class="mb-5">
                <input type="email" id="" class="myinput px-6 border border-gray-600 bg-transparent" placeholder="اكتب بريدك الالكتروني*" required />
            </div>
